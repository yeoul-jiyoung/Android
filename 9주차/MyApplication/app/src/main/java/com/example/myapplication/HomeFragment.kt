...
//            add(Album(id=2,title = "Lilac", singer = "아이유(IU)", coverImg = R.drawable.img_album_exp2))
//            add(Album(id=3,title = "Next Level", singer = "에스파(AESPA)", coverImg = R.drawable.img_album_exp3))
//            add(Album(id=4,title = "Boy with Luv", singer = "방탄소년단(BTS)", coverImg = R.drawable.img_album_exp4))
//            add(Album(id=5,title = "BBoom BBoom", singer = "모모랜드(MOMOLAND)", coverImg = R.drawable.img_album_exp5))
//            add(Album(id=6,title = "Weekend", singer = "태연(Tae Yeon)", coverImg = R.drawable.img_album_exp6))
//        }
